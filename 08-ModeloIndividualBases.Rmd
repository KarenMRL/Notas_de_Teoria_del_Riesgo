...
$Var(S)=\displaystyle\sum_{j=1}^{100}q_jVar(C_j)+q_j{\overbrace{{(1-q_j)}}^{p_j}}\mathbb{E}^2[C_j]$

$=200^2\displaystyle\sum_{j=1}^{100}[q_j+q_j(1-q_j)]\quad{\left\{\begin{array}{lcc} 
     Var(C_j)=\mathbb{E}^2[C_j]=200^2\\
\end{array}\right.}$

=$200^2[{\underbrace{{\text{(0.02+0.02(0.98))(45)}}}_{\text{Grupo 1}}}+{\underbrace{{\text{(0.04+0.04(0.96))(37)}}}_{\text{Grupo 2}}}+{\underbrace{\text{(0.07+0.07(0.93))(18)}}}_{\text{Grupo 3}}]=284,584$
