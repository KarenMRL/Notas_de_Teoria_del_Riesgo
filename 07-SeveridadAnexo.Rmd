...
\begin{equation*}
    ...
    \end{equation*}
\begin{equation*}
    = \mathbb P[Z\leq z | Z\in[a,d]] \mathbb P[Z\in [a,d]]\\\\
    \end{equation*}
\begin{equation*}
    + \mathbb P[Z\leq z | Z = d] \mathbb P[Z=d]\\\\
    \end{equation*}
\begin{equation*}
...
\begin{equation*}
    ...
    = \int_{\Omega} \int_{0}^{Y} py^{p-1}dydP = \int_{\Omega} Y^{p}dP = EY^{p}
\end{equation*}
...
$$\Rightarrow \mathbb{E}[H(X)]=\int_{\Omega}\left(\int_{\mathbb{R}}\mathbb{I}_{(-\infty,x]}(y)h(y)dy\right)dP\\\overset{\underset{\downarrow}{\text{Fubini}}}{=}\int_{\mathbb{R}}\left(\int_{\Omega}\mathbb{I}_{(-\infty,x]}(y)h(y)dP\right)dy\quad \left \{ \begin{matrix}
...
\begin{eqnarray*}
    ...
    \end{eqnarray*}
    \begin{eqnarray*}
    =1+\sum\limits_{n=0}^\infty\int^{n+1}_n\theta exp(\theta y)\mathbb{P}[X\geq y]dy =1+\sum\limits_{n=0}^\infty\int^{n+1}_n\theta exp(\theta y)\mathbb{P}[X>n]dy\\
    \end{eqnarray*}
    \begin{eqnarray*}
    =1+\sum\limits_{n=0}^\infty\mathbb{P}[X>n]\int^{n+1}_n\theta exp(\theta y)dy\quad\left\{\int^{n+1}_n\theta exp(\theta y)dy=e^{\theta(n+1)}-e^{\theta n}\right.\\
    \end{eqnarray*}
    \begin{eqnarray*}
    =1+\sum\limits_{n=0}^\infty \mathbb{P}[X>n](e^{\theta (n+1)}-e^{\theta n})=1+\sum\limits_{n=0}^\infty\mathbb{P}[X>n]e^{\theta n}(e^\theta-1)=1+(e^\theta-1)\sum\limits_{n=0}^\infty\mathbb{P}[X>n]e^{\theta n}\\
    \end{eqnarray*}
    \begin{eqnarray*}
